...
class RecepiesService
{
    ...
    async getRecipeById(recipeId){
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["from"])(fetch(`http://localhost:3000/recept?receptId=${recipeId}`) 
...
class MainPage {
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        boxText.innerHTML="Dobrodošli na naš sajt! Na korak ste od ukusnog i zdravog obroka!";
...
class MakingPage {
    ...
    drawMakingPage(content){
        ...
        const mainContentContainer= Object(_constants_createSomeElement__WEBPACK_IMPORTED_MODULE_2__["createSomeElement"])(content, "div", "mainContentContainer");
        const recipeBox= Object(_constants_createSomeElement__WEBPACK_IMPORTED_MODULE_2__["createSomeElement"])(mainContentContainer,"div","recipeBox");
        this._recipeService.getRecipeById(1);
        
        const recipeBoxNavBar= Object(_constants_createSomeElement__WEBPACK_IMPORTED_MODULE_2__["createSomeElement"])(recipeBox, "div", "recipeBoxNavBar");
        const recipeBoxPhase= Object(_constants_createSomeElement__WEBPACK_IMPORTED_MODULE_2__["createSomeElement"])(recipeBox, "div", "recipeBoxPhase");
...
class RecepiesPage {
    ...
    {
        const recipesBoxContainer= Object(_constants_createSomeElement__WEBPACK_IMPORTED_MODULE_1__["createSomeElement"])(recipesBox,"div", "recipesBoxContainer");
        this._recipeService.getRecepies()
        .then(recipes => {recipes=> recipes.forEach(recipe=>this.drawRecipe(recipesBoxContainer,recipe))})
        .catch(err => this.drawError(err));
    }
    drawRecipe(recipesBoxContainer,recipe)
    {
        const concreteRecipe= Object(_constants_createSomeElement__WEBPACK_IMPORTED_MODULE_1__["createSomeElement"])(recipesBoxContainer,"div", "concreteRecipe");
        const recipeName= Object(_constants_createSomeElement__WEBPACK_IMPORTED_MODULE_1__["createSomeElement"])(concreteRecipe,"div", recipeName);
        recipeName.innerHTML=recipe.naziv;
        console.log(recipe.naziv);
        const recipeType= Object(_constants_createSomeElement__WEBPACK_IMPORTED_MODULE_1__["createSomeElement"])(concreteRecipe,"div","recipeType");
        recipeType.innerHTML=recipe.tip;
        const recipeDuration= Object(_constants_createSomeElement__WEBPACK_IMPORTED_MODULE_1__["createSomeElement"])(concreteRecipe,"div","recipeDuration");
        recipeDuration= recipe.ukupno_trajanje;
        const recipeStart= Object(_constants_createSomeElement__WEBPACK_IMPORTED_MODULE_1__["createSomeElement"])(concreteRecipe,"button","recipeStart");
        recipeStart.innerHTML= "Pokreni pripremu";
    }
    drawError(recipeBox, err)
    {
        recipeBox.innerHTML = err;
    }
